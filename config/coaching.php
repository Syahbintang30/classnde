...
return [
    ...
    'coaches' => env('COACH_EMAILS', '') ? explode(',', env('COACH_EMAILS')) : [],
    // which package slugs make a user eligible to buy a coaching ticket
    // Admin can set package slugs like ['beginner','intermediate']
    'eligible_packages' => env('COACHING_ELIGIBLE_PACKAGES') ? explode(',', env('COACHING_ELIGIBLE_PACKAGES')) : ['beginner','intermediate'],
