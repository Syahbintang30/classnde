    ...
    @if(
        ...
        <nav class="global-nav" aria-label="Main navigation">
            <style>
                ...
                .global-nav .nav-wrap { background: linear-gradient(90deg, rgba(6,6,6,0.92), rgba(14,14,14,0.86)); border-bottom: 1px solid rgba(255,255,255,0.04); box-shadow: 0 8px 32px rgba(2,6,23,0.55); backdrop-filter: blur(6px); -webkit-backdrop-filter: blur(6px); }
                ...
                .nav-links a { color:#fff;text-decoration:none;font-weight:600;padding:6px 4px;position:relative;opacity:0.95;transition:color .14s ease, transform .14s ease; }
                .nav-links a:before { content: ''; position: absolute; left: 0; bottom: -6px; width: 0; height: 3px; border-radius:3px; background: linear-gradient(90deg,#ffd166,#ff6b6b); transition: width .22s cubic-bezier(.2,.9,.2,1); }
                .nav-links a:hover { transform: translateY(-4px); color: #fff; }
                ...
                .nav-username { color: rgba(255,255,255,0.92); font-weight:600; opacity:0.95; }
                .btn-ghost { background: transparent; color:#fff; border:1px solid rgba(255,255,255,0.06); padding:8px 12px; border-radius:10px; font-weight:700; transition: transform .12s ease, box-shadow .12s ease, background .12s ease; }
                .btn-ghost:hover { transform: translateY(-3px); box-shadow: 0 12px 30px rgba(0,0,0,0.5); background: rgba(255,255,255,0.03); }

                /* modern login button variant */
                .nav-login-button{display:inline-flex;align-items:center;gap:10px;background:transparent;color:#fff;padding:10px 14px;border-radius:12px;text-decoration:none;font-weight:700;border:1px solid rgba(255,255,255,0.06);transition:transform .14s ease,box-shadow .14s ease,opacity .14s ease}
